...
# Kill any existing processes on ports 5001 and 5001
...
echo "  - Indexes: http://localhost:5001/api/rag/indexes"
echo "  - Upload: http://localhost:5001/api/rag/upload"
echo "  - Query: http://localhost:5001/api/rag/query"
echo ""
