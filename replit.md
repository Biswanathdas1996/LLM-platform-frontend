...
- June 26, 2025. Added comprehensive analytics dashboard with three charts: Activity Over Time (bar chart), Status Code Distribution (pie chart), and Response Time Distribution (horizontal bar chart) using real Local LLM API log data
